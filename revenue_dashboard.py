...
engagement_increase = st.slider("Engagement Rate Increase (%)", min_value=0, max_value=100, value=0, step=1)

# Ad Revenue Split
st.header("Ad Revenue Split")
direct_sold_percentage = st.slider("Percentage of Direct Sold Ads", min_value=0, max_value=100, value=50, step=1)
